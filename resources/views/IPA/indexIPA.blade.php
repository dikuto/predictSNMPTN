    ...
    <div class="card-body">
       {{-- notifikasi--}}
        ...
        <div class="row">
            <div class="col-md">
        		...
        		<div class="modal fade" id="importExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        			<div class="modal-dialog" role="document">
        				<form method="POST" action="{{ route('importIPA') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <p>
                                                ...
                                                <a href="{{ route('formatFileIPA') }}" class="btn btn-info btn-sm">
            ...
            <div class="modal fade" id="deleteAll" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                      <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <a href="{{ route('deleteIPA') }}" class="btn btn-danger">Ya</a>
            ...
            <div class="col-md-4"> 
                <form action="{{ route('cariSiswaIPA') }}" method="GET">
            ...
            <table class="table table-bordered text-center" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <div class="modal fade" id="modal-info-{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
